      ...
      <div style={{ maxWidth: '64rem', margin: '0 auto' }}>
        <div className="card" style={{ 
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--space-3)', justifyContent: 'center', paddingTop: 'var(--space-2)' }}>
            <a href="/auth/register" className="btn btn-primary hover-lift" style={{ fontSize: '1rem', padding: 'var(--space-3) var(--space-6)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 'var(--space-2)' }}>
              Start Your Free Trial <ArrowRight size={20} />
            </a>
            <a href="/auth/login" className="btn btn-secondary" style={{ fontSize: '1rem', padding: 'var(--space-3) var(--space-6)', textDecoration: 'none' }}>
              Sign In
            </a>
          </div>
